...
<view class="container">
  <swiper class="banner" indicator-dots="true" autoplay="true" interval="3000" duration="1000">
    <swiper-item class="banner-item" v-for="item of banner" :key="item.id">
  ...
  <view class="a-section a-new" v-if="newGoods && newGoods.length">
    <view class="h">
      <view>
  ...
  <view class="a-section a-popular" v-if="hotGoods && hotGoods.length">
    <view class="h">
      <view>
  ...
  <view class="a-section a-topic" v-if="topics && topics.length">
    <view class="h">
      <view>
...
export default {
  computed: {
    ...mapState({
      newGoods: state => state.indexData.newGoods,
      hotGoods: state => state.indexData.hotGoods,
      topics: state => state.indexData.topics,
      brands: state => state.indexData.brands,
      floorGoods: state => state.indexData.floorGoods,
      banner: state => state.indexData.banner,
      channel: state => state.indexData.channel
    })
  },
  async mounted () {
    this.getIndexData()
